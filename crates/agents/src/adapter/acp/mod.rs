...
impl AcpProfile {
    pub(super) fn permission_mode(&self, access: crate::HarnessAccessMode) -> Option<&'static str> {
        let full = access == crate::HarnessAccessMode::Full;
