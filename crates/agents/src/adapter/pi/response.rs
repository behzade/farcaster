    ...
    let result = (|| -> Result<Payload, serde_json::Error> {
        Ok(match operation {
            ...
            SessionOperation::ListModels => {
                #[derive(Deserialize)]
                struct Models {
                    models: Vec<crate::extensions::Model>,
                }
            ...
            SessionOperation::ListModes => {
                #[derive(Deserialize)]
                struct Modes {
                    modes: Vec<crate::extensions::AgentMode>,
