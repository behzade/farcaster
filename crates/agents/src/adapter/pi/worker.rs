        ...
        loop {
            ...
            match event {
                    ...
                    if response.id.as_ref() == self.state_request.as_ref() =>
                {
                    ...
                    let Ok(crate::SessionResponsePayload::LoadState(state)) = response.result
                    else {
                ...
                SessionEvent::Response(crate::SessionResponse {
                    result: Err(error), ..
                }) => {
...
impl PiWorkerSession {
    ...
    fn route_prompt_response(&mut self, response: crate::SessionResponse) {
