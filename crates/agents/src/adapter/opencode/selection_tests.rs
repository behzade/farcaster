use super::*;
use crate::Backend;
use crate::{SessionCommand, SessionEvent, SessionResponsePayload as Payload, SessionTransport};
use std::{
    io::{Read, Write},
    net::TcpListener,
    sync::{
...
fn state(transport: &mut main_session::WorkerSessionTransport) -> crate::extensions::SessionState {
