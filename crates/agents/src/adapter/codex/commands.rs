...
impl State {
    pub(super) fn new(access: crate::HarnessAccessMode) -> Self {
        let permissions = match access {
            crate::HarnessAccessMode::Full => "full access",
            crate::HarnessAccessMode::Sandboxed => "sandboxed, user approvals",
            crate::HarnessAccessMode::Auto => "sandboxed, automatic approvals",
        };
        Self {
