...
pub struct TranscriptPresentation {
    ...
    pub active_start: Option<usize>,
    pub completed_runs: Arc<Vec<Range<usize>>>,
    pub insertions: Arc<Vec<(usize, Arc<TranscriptItem>)>>,
}
...
impl TranscriptPresentation {
    ...
    pub fn update_items(&mut self, source: &ConversationState, dirty: usize) -> usize {
    ...
    pub fn update_runs(&mut self, source: &ConversationState) {
