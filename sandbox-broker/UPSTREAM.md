...
| Improved denial collector and PID tracker | `484518f28433c37d3142c49d7060bd35462ce352` | `codex-rs/sandboxing/src/seatbelt_denials/mod.rs`, `pid_tracker.rs`, `seatbelt_denials_tests.rs` | PID tracker adapted in `src/pid_tracker.rs`; Pi made setup synchronous, added process start-time checks, and uses observations for best-effort cleanup. The denial collector remains planned |
