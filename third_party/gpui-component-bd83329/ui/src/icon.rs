...
/// Icons used by the extracted component subset, mapped to the application's
/// bundled Phosphor assets.
...
impl IconNamed for IconName {
    fn path(self) -> SharedString {
        match self {
            Self::CaseSensitive => "icons/phosphor/text-aa.svg",
            Self::Check => "icons/phosphor/check.svg",
            Self::CircleCheck => "icons/phosphor/check-circle.svg",
            Self::ChevronDown => "icons/phosphor/caret-down.svg",
            Self::ChevronLeft => "icons/phosphor/caret-left.svg",
            Self::ChevronRight => "icons/phosphor/caret-right.svg",
            Self::CircleX => "icons/phosphor/x-circle.svg",
            Self::Close => "icons/phosphor/x.svg",
            Self::ExternalLink => "icons/phosphor/arrow-square-out.svg",
            Self::Eye => "icons/phosphor/eye.svg",
            Self::EyeOff => "icons/phosphor/eye-slash.svg",
            Self::Inbox => "icons/phosphor/tray.svg",
            Self::Info => "icons/phosphor/info.svg",
            Self::Loader => "icons/phosphor/spinner-gap.svg",
            Self::Plus => "icons/phosphor/plus.svg",
            Self::Replace => "icons/phosphor/arrows-clockwise.svg",
            Self::Search => "icons/phosphor/magnifying-glass.svg",
            Self::TriangleAlert => "icons/phosphor/warning-circle.svg",
        }
        .into()
    }
}
