...
pub(in crate::app::views) struct SessionChangeTotals {
    pub(in crate::app::views) additions: Option<u64>,
    pub(in crate::app::views) deletions: Option<u64>,
}

impl FarcasterApp {
    pub(in crate::app::views) fn render_session_change_fallback(
        &self,
...
pub(in crate::app::views) fn session_change_totals(changes: &ChangeSet) -> SessionChangeTotals {
    SessionChangeTotals {
