mod attachments;
pub(in crate::app::views) mod footer;
mod models;
#[cfg(test)]
mod tests;
...
use super::super::{
    ...
    ComposerHistoryPrevious, FarcasterApp, file_mentions,
};
use crate::{
    agents::PeerMessage,
    app::composer::user_invocations::{self, ComposerSuggestion},
    app::composer::{file_mentions::MentionQuery, sessions::ComposerSnapshot, slash_commands},
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .when_some(
                        attachments::render(self, attachments_entity),
