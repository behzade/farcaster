...
pub(crate) use core::{
    ...
    delete_state, descendant_sessions, document_is_live, filter_session_tree, index_sessions,
    is_subagent_path, normalize_lexical, normalize_session_path, relocate_state,
