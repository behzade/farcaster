...
pub(crate) use core::{
    ...
    count_cache_hit, count_parse, count_scan, delete_state, descendant_sessions, document_is_live,
    filter_session_tree, index_sessions, is_subagent_path, normalize_lexical,
