...
pub(crate) use adapter::{
    ...
    is_external_session, load_configuration_catalog, load_external_history, normalize_access_mode,
    rename_session, spawn_session, supported_access_modes, supports_startup_command,
