...
pub(crate) use adapter::{
    ...
    discover_external_sessions, is_external_session, load_configuration_catalog,
    load_external_history, rename_session, spawn_session, validate_launch, worker_factories,
};
...
pub(crate) use contract::{
    ...
    FileAccessMode, NetworkAccessMode, PermissionLevel, QueuedPrompt, SessionCommand, SessionEvent,
    SessionLaunch, SessionResponse, SessionStart, SessionTransport,
